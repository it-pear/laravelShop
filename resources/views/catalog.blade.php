                  ...
                  <div class="widget-filters__list">
                    ...
                    <div class="widget-filters__item">
                      <div class="filter filter--opened" data-collapse-item>
                        ...
                        <div class="filter__body" data-collapse-content>
                          <div class="filter__container">
                            <div class="filter-price" data-min="0" data-max="20000"
                              @if( request()->toprice == '')
                                data-from="0"
                              @else
                          ...
                          <input type="hidden" class="doprice" name="doprice" value="20000">
                        </div>
                        <div class="filter">
                          <div>
                            <label>Сортировка цены</label>
                            <div>
                              <select class="form-control form-control-sm" name="sortprice" id="">
