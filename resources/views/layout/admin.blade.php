      ...
      <ul class="nav flex-row">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('properties.index') }}">
            <svg width="24" height="24" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <span class="title">Свойства товаров</span>
          </a>
        </li>
