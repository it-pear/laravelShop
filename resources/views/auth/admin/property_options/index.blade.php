...
<h2>Параметры свойств товаров ({{ $property->name }})</h2>
<div class="table-responsive table-admin-propertyOptions">
  ...
  <br>
  <a href="{{ route('property-options.create', $property) }}" class="btn btn-info">Создать вариант свойства</a>
</div>
