...
<div class="form-admin">
  ...
  >
    ...
    <div class="form-group">
      ...
      <input type="text" pattern="[A-Za-z]{6,}" name="code" class="form-control" required value="@isset($category)">
      <!-- <small class="form-text text-muted">We'll never share your email with anyone else.</small> -->
    </div>
    <div class="form-group">
      <label>Название</label>
      <input type="text" name="name" class="form-control" required value="@isset($category)">
    </div>
    <div class="form-group">
      <label>Описание</label>
      <textarea name="description" class="form-control" rows="3" value="@isset($category)"></textarea>
    </div>
    <div class="form-group">
